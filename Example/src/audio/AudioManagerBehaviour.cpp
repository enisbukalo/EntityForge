...
void AudioManagerBehaviour::onCreate(Entity self, World& world)
{
...
void AudioManagerBehaviour::adjustMasterVolume(float delta)
{
...
void AudioManagerBehaviour::serializeFields(Serialization::ScriptFieldWriter& out) const
{
    out.setFloat("masterVolume", static_cast<double>(m_currentMasterVolume));
}

void AudioManagerBehaviour::deserializeFields(const Serialization::ScriptFieldReader& in)
{
